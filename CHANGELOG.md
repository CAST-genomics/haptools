...
## [0.7.0](https://github.com/CAST-genomics/haptools/compare/v0.6.0...v0.7.0) (2025-12-10)
...
* `Genotypes.check_maf()` method ([dd4fa9e](https://github.com/CAST-genomics/haptools/commit/dd4fa9e6225f56cbefc546dc43b8750d9491c774))
...
* consider ancestry in `transform` ([cd66723](https://github.com/CAST-genomics/haptools/commit/cd66723ed558ec858885912686f642da0cf02f5d))
...
* github actions ([2c36d28](https://github.com/CAST-genomics/haptools/commit/2c36d28a3f104e47b44523791ba461923b5f1737))
...
* ld command ([b5d18fc](https://github.com/CAST-genomics/haptools/commit/b5d18fc9cae0fcb094ab66761f62f5c21f3c82d6))
...
* new github actions ([61fa7e2](https://github.com/CAST-genomics/haptools/commit/61fa7e2ccd40893b07bc22935d34233fa09194d8))
* new index subcommand ([d1a75fd](https://github.com/CAST-genomics/haptools/commit/d1a75fdecf6911e20c07777978d82e5ee7a76cd4))
* plink2 support ([c8a7773](https://github.com/CAST-genomics/haptools/commit/c8a77737c5882856edad590cfedde38430f86fbe))
...
* use bp file in `transform` ([8a20ccd](https://github.com/CAST-genomics/haptools/commit/8a20ccd22b31a110b321e5edc9445d155407f874))
...
* `.hap` format header line sorting and allow extra 'extra' fields ([#65](https://github.com/CAST-genomics/haptools/issues/65) and [#66](https://github.com/CAST-genomics/haptools/issues/66)) ([d99b51a](https://github.com/CAST-genomics/haptools/commit/d99b51a7f05c8ac9e8db0e6d0f599d2e1120ece6))
...
* allow extra 'extra' fields ([#66](https://github.com/CAST-genomics/haptools/issues/66)) ([b4b9cd5](https://github.com/CAST-genomics/haptools/commit/b4b9cd56ff01c6adaa557cdc7da2a67db1ffa893))
...
* conflicting short params in simphenotype ([d4f7542](https://github.com/CAST-genomics/haptools/commit/d4f7542e1a7f21924ce3c72893902b2e8b27af10))
...
* file reads and writes in py3.10+ ([e717e49](https://github.com/CAST-genomics/haptools/commit/e717e499a0b33862c99be5f44c2e14cee0407235))
...
* NaNs output by simphenotype ([eebaf41](https://github.com/CAST-genomics/haptools/commit/eebaf4164edcf7da66898acc6ddeafc0bb385d89))
...
* transform command typo and improve docs ([33eafeb](https://github.com/CAST-genomics/haptools/commit/33eafeb26d128b2aaf17673e54bb09b4685c2282))
...
* wideness of phenotype distribution ([929d113](https://github.com/CAST-genomics/haptools/commit/929d113b6c9c935565c033c4eb24f39c8acdf9e6))
...
* add karyogram module to API page ([4f2b7a7](https://github.com/CAST-genomics/haptools/commit/4f2b7a7d4c0ab8c06116ff2ebb0345b2041d4f7a))
...
* cleanup and improve descriptions ([7a19ffa](https://github.com/CAST-genomics/haptools/commit/7a19ffaf2a0ddc9186ba21d94d01790149732719))
...
* fix simgenotype docstrings on API page ([37aa4fe](https://github.com/CAST-genomics/haptools/commit/37aa4feeabc6367d6f66b7c411254c572f3c0b1e))
...
* link to hap page from simphenotype ([7a84f8a](https://github.com/CAST-genomics/haptools/commit/7a84f8aee0a71ae9cbf9dfdeb0fc1b7c966c2640))
...
* update snp2hap example ([1ff23b6](https://github.com/CAST-genomics/haptools/commit/1ff23b6b569b5e14d90aa10071f0cb9f6ba3a143))

...
To create a pull request you need to do these steps:
    ...
    5. Create a new branch off of the ``main`` branch with :code:`git checkout -b <descriptive_branch_name>`. Please follow `best practices <https://www.conventionalcommits.org/>`_ when naming your branch

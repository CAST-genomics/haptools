...
def test_with_empty_lines():
    assert val_hapfile.is_hapfile_valid(DATADIR / "valhap_with_empty_lines.hap")
...
def test_with_10_extras_reordered():
    assert val_hapfile.is_hapfile_valid(DATADIR / "valhap_with_10_extras_reordered.hap")
...
def test_with_no_version():
    assert not val_hapfile.is_hapfile_valid(DATADIR / "valhap_with_no_version.hap")


def test_with_multiple_versions():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_multiple_versions.hap"
    )
...
def test_with_insufficient_columns():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_insufficient_columns.hap"
    )


def test_with_inconvertible_starts():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_inconvertible_starts.hap"
    )


def test_with_inconvertible_ends():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_inconvertible_ends.hap"
    )
...
def test_with_inconvertible_ends_var():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_inconvertible_ends_var.hap"
    )


def test_valhap_with_start_after_end():
    assert not val_hapfile.is_hapfile_valid(DATADIR / "valhap_with_start_after_end.hap")


def test_is_directory():
    assert not val_hapfile.is_hapfile_valid(DATADIR / "valhap_is_directory.hap")
...
def test_with_hrid_of_chromosome():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_hrid_of_chromosome.hap"
    )
...
def test_with_unassociated_haplotype():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_unassociated_haplotype.hap"
    )


def test_with_unrecognizable_allele():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_unrecognizable_allele.hap"
    )


def test_with_duplicate_ids():
    assert not val_hapfile.is_hapfile_valid(DATADIR / "valhap_with_duplicate_ids.hap")
...
def test_with_excol_of_wrong_type():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_excol_of_wrong_type.hap"
    )


def test_with_multiple_order_defs():
    assert not val_hapfile.is_hapfile_valid(
        DATADIR / "valhap_with_multiple_order_defs.hap"
    )

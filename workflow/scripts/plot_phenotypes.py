...
def parse_args():
    parser = argparse.ArgumentParser(
        description=
        "Plot phenotypes against genotypes in a phens.tsv.gz file."
    )
    parser.add_argument(
        '-o', '--out', help='path to plot PNG file'
    )
    parser.add_argument(
    ...
    parser.add_argument(
        'phens', nargs='?', default=sys.stdin,
        help='a tab-separated table composed of genotypes and a phenotype (the last column)'
    )
